...
import com.hzp.takeout.presenter.net.bean.HomeInfo;
import com.hzp.takeout.presenter.net.bean.HomeItem;
import com.hzp.takeout.presenter.net.bean.Promotion;
